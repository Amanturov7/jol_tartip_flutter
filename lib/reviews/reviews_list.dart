...
class _ReviewsListState extends State<ReviewsList> {
  ...
  Future<void> fetchData() async {
    try {
      String url = 'http://192.168.88.202:8080/rest/reviews/all?';
  ...
  Future<void> fetchFilterOptions() async {
    try {
      final ecologicFactorsUrl = Uri.parse(
          'http://192.168.88.202:8080/rest/common-reference/by-type/007');
      final roadSignsUrl = Uri.parse(
          'http://192.168.88.202:8080/rest/common-reference/by-type/003');
      final lightsUrl = Uri.parse(
          'http://192.168.88.202:8080/rest/common-reference/by-type/004');
      final roadsUrl = Uri.parse(
          'http://192.168.88.202:8080/rest/common-reference/by-type/005');
              ...
              children: [
                Expanded(
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.network(
                      'http://192.168.88.202:8080/rest/attachments/download/reviews/${review['id']}',
                      fit: BoxFit.cover,
